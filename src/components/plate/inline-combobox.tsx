...
const InlineComboboxContent: typeof ComboboxPopover = ({
  ...
  return (
    <Portal>
      <ComboboxPopover
        className={cn(
          'z-[500] max-h-[288px] w-[300px] overflow-y-auto rounded-md bg-white shadow-md dark:bg-zinc-950',
          className,
        )}
        {...props}
      />
...
const comboboxItemVariants = cva(
  'relative flex h-9 select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none',
  {
    ...
    variants: {
      interactive: {
        false: '',
        true: 'cursor-pointer transition-colors hover:bg-zinc-100 hover:text-zinc-900 data-[active-item=true]:bg-zinc-100 data-[active-item=true]:text-zinc-900 dark:hover:bg-zinc-800 dark:hover:text-zinc-50 dark:data-[active-item=true]:bg-zinc-800 dark:data-[active-item=true]:text-zinc-50',
      },
    },
  },
)
