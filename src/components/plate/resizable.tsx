...
export const mediaResizeHandleVariants = cva(
  cn(
    ...
    'after:flex after:h-16 after:w-[3px] after:rounded-[6px] after:bg-zinc-950 after:opacity-0 after:content-[_] group-hover:after:opacity-100 dark:after:bg-zinc-300',
  ),
  {
    variants: {
      direction: {
